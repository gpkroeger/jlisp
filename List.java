...
public class List extends Expr {
    ...
    //closed paren which are not present wihtin the indices at the time of passing through
    ...
    //this is called with the first index as an open paren and by the closing index should contain the
